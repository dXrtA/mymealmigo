          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-6 lg:space-x-8">
                ...
                {/* About Project opens modal (no route) */}
                <button
                  type="button"
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden" id="mobile-menu">
            <div className="pt-2 pb-3 space-y-1">
              ...
              {/* About Project → open modal and close menu */}
              <button
                type="button"
                onClick={() => { setShowProject(true); setMobileMenuOpen(false); }}
                className="w-full text-left text-gray-500 hover:bg-gray-50 hover:text-[#58e221] block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium"
              >
                About Project
              </button>
