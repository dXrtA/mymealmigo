    ...
    <div className="about-project bg-white p-8 rounded-lg max-w-6xl mx-auto">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { name: "Bryce Nicolas Fernandez", role: "Project Leader", bio: "TBC" },
            { name: "Ridhwan Putra", role: "Software Developer", bio: "TBC" },
            { name: "Gabriel Leu Jun Yang", role: "Software Developer", bio: "TBC" },
            { name: "D'Atagnan Kong Yih Ferng", role: "Software Developer", bio: "TBC" },
            { name: "Kenneth Chua Yi Sheng", role: "Software Developer", bio: "TBC" },
          ].map((member, index) => (
            <div key={index} className="team-member p-6 border rounded-lg shadow-md hover:shadow-lg transition bg-white">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div key={index} className="mentor p-6 border rounded-lg shadow-md hover:shadow-lg transition bg-white">
              <div className="w-32 h-32 bg-gradient-to-r from-[#58e221] to-[#80e259] opacity-80 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold">
